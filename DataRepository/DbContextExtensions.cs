...
namespace DataRepository
{
    public static class DbContextExtensions
    {
        ...
        private static T InnerGetCopy<T>(DataContext context, T currentCopy, Func<DbEntityEntry<T>, DbPropertyValues> func) where T : BaseEntity
        {
        ...
        private static DbContext CastOrThrow(DataContext context)
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadOriginalCopy<T>(this DataContext context, T currentCopy) where T : BaseEntity
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadDatabaseCopy<T>(this DataContext context, T currentCopy) where T : BaseEntity
        {
        ...
        public static string GetTableName<T>(this DataContext context) where T : BaseEntity
        {
        ...
        public static int? GetColumnMaxLength(this DataContext context, string entityTypeName, string columnName)
        {
