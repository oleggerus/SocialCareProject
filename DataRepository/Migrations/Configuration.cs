    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataRepository.DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            ...
            var wheelChairOffer = new Offer
            {
                Product = wheelChair,
                CreatedBy = provider,
                Description = "Я підготував цю пропозицію для Вас, оскільки чув, що Ви шукаєте саме такий інвалідний візок",
                IsDeleted = false,
            ...
            var bonesOffer = new Offer
            {
                Product = bones,
                CreatedBy = providerWithoutVendor,
                Description = "Думаю, ця пропозиція має Вас зацікавити, оскільки це найдешевший із варіантів представлених на сайті",
                IsDeleted = false,
